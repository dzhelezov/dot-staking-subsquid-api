...
export class StakingRewardResolver {
  ...
  @FieldResolver(() => SumReward)
  async account(@Root() r: StakingReward, @Ctx() ctx: BaseContext): Promise<SumReward | null> {
    return ctx.dataLoader.loaders.StakingReward.account.load(r);
  }
}
